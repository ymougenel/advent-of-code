...
class TestDay6(unittest.TestCase):
    ...
    def setUp(self):
        ...
        #                \
        #                 I
        self.g4 = {'COM': ['B'], 'B': ['C', 'G'], 'C': ['D'], 'D': ['E', 'I'], 'E': ['F', 'J'], 'G': ['H'], 'J': ['K'],
                   'K': ['L']}
    ...
    def test_get_direction(self):
        self.assertEqual(day6.get_path(self.g1, 'COM', 'B'), ['COM', 'A', 'B'])
        self.assertEqual(day6.get_path(self.g2, 'COM', 'B'), ['COM', 'A', 'B'])
        self.assertEqual(day6.get_path(self.g4, 'COM', 'L'), ['COM', 'B', 'C', 'D', 'E', 'J', 'K', 'L'])
        self.assertEqual(day6.get_path(self.g4, 'COM', 'I'), ['COM', 'B', 'C', 'D', 'I'])
